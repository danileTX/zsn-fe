...
export const useLogin = ({ pId = 0 }) => {
  ...
  const state0 = (<>
    ...
    <Row align="middle" justify="center">
      <div className={styles['text']}>
        We will send you an email with verification code, your email address will be an important identification for your asset on ZSN.
      </div>
    </Row>
    <Row align="middle">
      <Col span={24}>
  ...
  const state4 = (<>
    ...
    <Row justify="center">
      {/* <div className={styles['text']}>
        ZSN official Twitter provides the newest updates about our platform and general crypto world.
  ...
  const state6 = (<>
    ...
    <Row justify="center">
      <div className={styles['text']}>
        ...
        Join <b>ZSN</b> Telegram community and <b>{loginConfig?.projectName}</b> Telegram community to get the newest updates about the ongoing campaign!
      </div>
    </Row>
