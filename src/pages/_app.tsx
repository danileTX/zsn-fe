  ...
  return (
    <Providers>
      <Head>
        ...
        <meta name="description" content="ZSN is the first exclusive launchpad for decentralized fundraising in Boba ecosystem, offering the hottest and innovative projects in a fair, secure, and efficient way." />
        {/* <meta name="keywords" content="BobaBrewery ZSN"/> */}
        <style>
          {`
            :root {
              --header-height: 110px;
