      ...
      <div className="main-content">
        ...
        <Row>
          <Col span={isDesktopOrLaptop ? 18 : 24}>
            <h1 className="title">
              ZSN: Fundraising platform
              <br />
              on Sepolia
            </h1>
            <div className="desc">
              ZSN is the first exclusive launchpad for decentralized fundraising
              <br />
        ...
        <div className="main-content">
          <Row align="middle">
            <Col span={isDesktopOrLaptop ? 12 : 24} className={styles['appear']}>
              ...
              <div className="desc">
                Bringing the world-class projects to ZSN and making it
                <br />
    ...
    <ScrollAnimation scrollableParentSelector={'.main-body'} animateIn={styles['animated-5']} animateOnce>
      <section className={`${styles['sec-5']} ${styles['sec']} sec-5 ${styles['appear']}`}>
        <div className="main-content">
          ...
          <div className="desc">
            Feel free to easily access resources in ZSN that help you succeed at every step from fundraising to market expansion. Besides raising money,
            <br />
