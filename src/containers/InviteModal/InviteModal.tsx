        ...
        <Row justify='center' gutter={[24, 24]}>
            ...
            <Col span={24} style={{ textAlign: 'center' }}>
                <TelegramShareButton
                    ...
                    url={url}
                    title={`Come to join ${projectName} IDO & AIRDROP on ZSN launchpad, BOBA- native, community governed NFT marketplace, exploring BOBA NFT here!`}>
